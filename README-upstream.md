# N64ever (a modified fork of N64FlashcartMenu)

> **N64ever** is a modified fork of **N64FlashcartMenu**, by Bjerreman and
> contributors, based on N64FlashcartMenu **V0.3.2** (© Robin Jones / NetworkFusion, Mateusz
> Faderewski / Polprzewodnikowy, and contributors). It adds a cover-art Favorites Grid, a baked-in
> box-art/metadata library, a unified popup UI, and more. Licensed under **GNU AGPL-3.0** (see
> `LICENSE.md`). See **`NOTICE`** for the modification statement and **`README.md`** for the full
> fork documentation and changelog.
>
> *The original N64FlashcartMenu README follows below.*
...
The grid navigation, launch and settings effects (`grid_move`, `grid_enter`, `grid_back`, `launch`,
`settings`) are **original sound effects synthesised for N64ever** - no samples or third-party audio.
They are reproducible from `tools/gen_sfx.py` (pure synthesis, Python standard library) and are free to use.
...
* [PixelMplus](https://github.com/itouhiro/PixelMplus) by *itouhiro* / *M+ FONTS PROJECT* - (M+ FONT LICENSE)
